...
// Tue Feb  3 21:26:48 2026 by ROOT version 6.38.00
// from TTree tree/Output TTree
// found on file: hyperonAnalysisBKG.root
//////////////////////////////////////////////////////////
...
#ifdef bkgDef_cxx
bkgDef::bkgDef(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("hyperonAnalysisBKG.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("hyperonAnalysisBKG.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("hyperonAnalysisBKG.root:/ana");
...
Int_t bkgDef::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bkgDef::LoadTree(Long64_t entry)
{
...
void bkgDef::Show(Long64_t entry)
{
...
Int_t bkgDef::Cut(Long64_t entry)
{
