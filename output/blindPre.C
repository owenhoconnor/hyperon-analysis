...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *validFile = new TFile("validSample.root", "RECREATE");
   TTree *validTree = new TTree("validTree", "validTree");
   validTree->SetDirectory(validFile);
   ...
   validTree->Branch("track2Length", &track2Length);
   validTree->Branch("track3Length", &track3Length);
   validTree->Branch("shower1Length", &shower1Length);

   // Track, shower start positions
   validTree->Branch("track1StartPosX", &track1StartPosX, "track1StartPosX/F");
   validTree->Branch("track1StartPosY", &track1StartPosY, "track1StartPosY/F");
   validTree->Branch("track1StartPosZ", &track1StartPosZ, "track1StartPosZ/F");

   validTree->Branch("track2StartPosX", &track2StartPosX, "track2StartPosX/F");
   validTree->Branch("track2StartPosY", &track2StartPosY, "track2StartPosY/F");
   validTree->Branch("track2StartPosZ", &track2StartPosZ, "track2StartPosZ/F");

   validTree->Branch("track3StartPosX", &track3StartPosX, "track3StartPosX/F");
   validTree->Branch("track3StartPosY", &track3StartPosY, "track3StartPosY/F");
   validTree->Branch("track3StartPosZ", &track3StartPosZ, "track3StartPosZ/F");

   validTree->Branch("shower1StartPosX", &shower1StartPosX, "shower1StartPosX/F");
   validTree->Branch("shower1StartPosY", &shower1StartPosY, "shower1StartPosY/F");
   validTree->Branch("shower1StartPosZ", &shower1StartPosZ, "shower1StartPosZ/F");


// Track, shower direction vectors
   validTree->Branch("track1StartDirX", &track1StartDirX, "track1StartDirX/F");
   validTree->Branch("track1StartDirY", &track1StartDirY, "track1StartDirY/F");
   validTree->Branch("track1StartDirZ", &track1StartDirZ, "track1StartDirZ/F");

   validTree->Branch("track2StartDirX", &track2StartDirX, "track2StartDirX/F");
   validTree->Branch("track2StartDirY", &track2StartDirY, "track2StartDirY/F");
   validTree->Branch("track2StartDirZ", &track2StartDirZ, "track2StartDirZ/F");

   validTree->Branch("track3StartDirX", &track3StartDirX, "track3StartDirX/F");
   validTree->Branch("track3StartDirY", &track3StartDirY, "track3StartDirY/F");
   validTree->Branch("track3StartDirZ", &track3StartDirZ, "track3StartDirZ/F");

   validTree->Branch("shower1DirX", &shower1DirX);
   validTree->Branch("shower1DirY", &shower1DirY);
   validTree->Branch("shower1DirZ", &shower1DirZ);

// Distances to reconstructed vertex
   validTree->Branch("track1DistRecoVtx", &track1DistRecoVtx, "track1DistRecoVtx/F");
   validTree->Branch("track2DistRecoVtx", &track2DistRecoVtx, "track2DistRecoVtx/F");
   validTree->Branch("track3DistRecoVtx", &track3DistRecoVtx, "track3DistRecoVtx/F");

   validTree->Branch("shower1DistRecoVtx", &shower1DistRecoVtx, "shower1DistRecoVtx/F");

// Track-track, track-shower angles
   validTree->Branch("track1Track2Angle", &track1Track2Angle);
   validTree->Branch("track1Track3Angle", &track1Track3Angle);
   validTree->Branch("track2Track3Angle", &track2Track3Angle);
   validTree->Branch("track1Shower1Angle", &track1Shower1Angle);
   validTree->Branch("track2Shower1Angle", &track2Shower1Angle);
   validTree->Branch("track3Shower1Angle", &track3Shower1Angle);

// Track-track, track-shower distances
   validTree->Branch("track1Track2Dist", &track1Track2Dist);
   validTree->Branch("track1Track3Dist", &track1Track3Dist);
   validTree->Branch("track2Track3Dist", &track2Track3Dist);
   validTree->Branch("track1Shower1Dist", &track1Shower1Dist);
   validTree->Branch("track2Shower1Dist", &track2Shower1Dist);
   validTree->Branch("track3Shower1Dist", &track3Shower1Dist);
...
// trueP and truePDG
   ...
   validTree->Branch("DaughterPDG", &DaughterPDG);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	//      std::cout<<"track "<<i<<" start position = "<<trackStartPositionX->at(i)<<", "<<trackStartPositionY->at(i)<<", "<<trackStartPositionZ->at(i)<<std::endl;
      ...
      TrueP = *trueP;
      TruePDG = *truePDG;
      DaughterPDG = *daughterPDG;

      // Fill validation tree:

      nGoodTopo++;
      validTree->Fill();
      std::cout<<"Filled validation tree"<<std::endl;
   
   }

   std::cout<<"number of events passing preselection cuts: "<<nGoodTopo<<" out of "<<nentries<<"."<<std::endl;

   validFile->cd();
   validTree->Write("validTree");
   validFile->Close();
   delete validFile;
}
