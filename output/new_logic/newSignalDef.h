...
#ifndef newSignalDef_h
#define newSignalDef_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   newSignalDef(TTree *tree=0);
   virtual ~newSignalDef();
...
#ifdef newSignalDef_cxx
newSignalDef::newSignalDef(TTree *tree) : fChain(0) 
{
...
newSignalDef::~newSignalDef()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t newSignalDef::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t newSignalDef::LoadTree(Long64_t entry)
{
...
void newSignalDef::Init(TTree *tree)
{
...
void newSignalDef::Show(Long64_t entry)
{
...
Int_t newSignalDef::Cut(Long64_t entry)
{
