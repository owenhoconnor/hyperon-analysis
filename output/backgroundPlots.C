...
void backgroundPlots::Loop()
{
    ...
    TH1F* hTrueOrigin = new TH1F("hTrueOrigin", "", 4, -0.5, 4.5);
    hTrueOrigin->SetDirectory(nullptr);
    hTrueOrigin->GetXaxis()->SetBinLabel(2, "Beam Neutrino");
    hTrueOrigin->GetXaxis()->SetBinLabel(3, "Cosmic");
