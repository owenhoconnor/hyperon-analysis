...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   Float_t track1StartPosX, track1StartPosY, track1StartPosZ;
   Float_t track2StartPosX, track2StartPosY, track2StartPosZ;
   Float_t track3StartPosX, track3StartPosY, track3StartPosZ;
   Float_t shower1StartPosX, shower1StartPosY, shower1StartPosZ; 
...
*/
   ...
   reader->AddVariable("track1StartPosX", &track1StartPosX);
   reader->AddVariable("track1StartPosY", &track1StartPosY);
   reader->AddVariable("track1StartPosZ", &track1StartPosZ);
   reader->AddVariable("track2StartPosX", &track2StartPosX);
   reader->AddVariable("track2StartPosY", &track2StartPosY);
   reader->AddVariable("track2StartPosZ", &track2StartPosZ);
   reader->AddVariable("track3StartPosX", &track3StartPosX);
   reader->AddVariable("track3StartPosY", &track3StartPosY);
   reader->AddVariable("track3StartPosZ", &track3StartPosZ);
   reader->AddVariable("shower1StartPosX", &shower1StartPosX);
   reader->AddVariable("shower1StartPosY", &shower1StartPosY);
   reader->AddVariable("shower1StartPosZ", &shower1StartPosZ);
   ...
   //
   TFile *input(nullptr);
   TString fname = "../../validSample.root";
   ...
   TTree* signalTree = (TTree*)input->Get("validTree");
   ...
   signalTree->SetBranchAddress( "track1StartPosX", &track1StartPosX);
   signalTree->SetBranchAddress( "track1StartPosY", &track1StartPosY);
   signalTree->SetBranchAddress( "track1StartPosZ", &track1StartPosZ);
   signalTree->SetBranchAddress( "track2StartPosX", &track2StartPosX);
   signalTree->SetBranchAddress( "track2StartPosY", &track2StartPosY);
   signalTree->SetBranchAddress( "track2StartPosZ", &track2StartPosZ);
   signalTree->SetBranchAddress( "track3StartPosX", &track3StartPosX);
   signalTree->SetBranchAddress( "track3StartPosY", &track3StartPosY);
   signalTree->SetBranchAddress( "track3StartPosZ", &track3StartPosZ);
   signalTree->SetBranchAddress( "shower1StartPosX", &shower1StartPosX);
   signalTree->SetBranchAddress( "shower1StartPosY", &shower1StartPosY);
   signalTree->SetBranchAddress( "shower1StartPosZ", &shower1StartPosZ);
   ...
   TFile *output = TFile::Open("validTree_BDT.root", "RECREATE");
   output->cd();

   TTree *outTree = signalTree->CloneTree(0);
   outTree->SetName("validTree_BDT");

   Float_t BDTScore;
   Bool_t PassBDT;

   outTree->Branch("BDTScore", &BDTScore, "BDTScore/F");
   outTree->Branch("PassBDT",  &PassBDT,  "PassBDT/O"); // O = bool branch

   // Efficiency calculator for cut method
   Int_t    nSelCutsGA = 0;
   Double_t effS       = 0.7;
   
   Float_t cutValue = 0.3131;
   ...
   if (Use["CutsGA"]) std::cout << "--- Efficiency for CutsGA method: " << double(nSelCutsGA)/signalTree->GetEntries()
