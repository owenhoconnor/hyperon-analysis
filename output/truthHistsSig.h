...
// Thu Jan 22 15:20:25 2026 by ROOT version 6.28/12
// from TTree TreeS/Output TTree
// found on file: hyperonAnalysisSIG.root
//////////////////////////////////////////////////////////

#ifndef truthHistsSig_h
#define truthHistsSig_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   truthHistsSig(TTree *tree=0);
   virtual ~truthHistsSig();
...
#ifdef truthHistsSig_cxx
truthHistsSig::truthHistsSig(TTree *tree) : fChain(0) 
{
...
truthHistsSig::~truthHistsSig()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t truthHistsSig::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t truthHistsSig::LoadTree(Long64_t entry)
{
...
void truthHistsSig::Init(TTree *tree)
{
...
void truthHistsSig::Show(Long64_t entry)
{
...
Int_t truthHistsSig::Cut(Long64_t entry)
{
